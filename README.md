...
T1595 (Active Scanning): The fingerprinter tool identifies the tools used based on behavior (e.g., Nmap pattern = many services in a short time). Detection maps to MITRE ATT&CK T1046 + T1595 with <1s response
